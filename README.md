...
> **ChatGPT Work support:** This fork includes a native subagent plugin that runs without tmux or local AI CLIs, with concise Sengoku-period drama live council updates by default, grounded in real subagent events. See [Multi-Agent Shogun for ChatGPT Work](CHATGPT_WORK.md).
